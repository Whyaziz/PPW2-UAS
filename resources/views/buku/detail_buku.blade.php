            ...
            <div class="overflow-hidden rounded-lg shadow-md m-5">
                <section id="album" class="py-4 text-center bg-light">
                    <div class="container mx-auto">
                        ...
                        <!-- categories form -->
                        <form method="POST" action="{{ route('categories.store', ['bookId' => $bukus->id]) }}">
                            @csrf
                            ...
                            <button type="submit" class="bg-blue-500">Add Category</button>
                        </form>
                        <form method="POST" action="{{ route('categories.store', ['bookId' => $bukus->id]) }}">
                            @csrf

                            <div class="form-group">
                                <label for="name">Masukkan Review</label>
                                <input type="text" class="form-control" id="name" name="name" required>
                            </div>

                            <button type="submit" class="bg-blue-500">Tambahkan Review</button>
                        </form>
