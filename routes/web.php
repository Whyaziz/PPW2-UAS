...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/buku/popular', [ControllerBuku::class, 'topRatedBooks'])->name('buku.topRatedBooks');
    Route::post('/categories/{bookId}', [CategoryController::class, 'store'])->name('categories.store');
});
